...
import { Array, Struct, uint8 } from '../src/index.js';

describe('Array', function () {
  describe('decode', function () {
    it('should decode fixed length', function () {
      const array = new Struct({ arr: Array(uint8, 4) });
  ...
  describe('encode', function () {
    ...
    it('should encode using array length', function () {
      const array = new Struct({ arr: Array(uint8, 10) });
